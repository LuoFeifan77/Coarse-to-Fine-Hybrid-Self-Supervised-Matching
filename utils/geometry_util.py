...
# elastic basis computation adapted from original implementation https://github.com/flrneha/ElasticBasisForSpectralMatching
import os
...
import pyshell   # for elastic basis computation
import scipy.sparse
